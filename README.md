...
| GET | `/api/search?q=<query>` | Search **title or author** — KMP exact substring match, else Levenshtein fuzzy fallback (≤3, min distance over title/author). Returns `{results, matched_by, did_you_mean}` |
