...
| GET | `/api/search?q=<query>` | Searches title OR author. KMP exact substring match, else Levenshtein fuzzy fallback (≤3, min over title/author); returns `{results, matched_by, did_you_mean}` |
